...
import { Award, BarChart2, CheckCircle, Clock, XCircle, Eye, BookOpen, ArrowUpWideNarrow,FileText, User, HelpCircle, Target, Users } from 'lucide-react';
                ...
                <div className="scoredetails-summary">
                    <div className="scoredetails-summary-card scoredetails-primary">
                        ...
                        <div className="scoredetails-content">
                            <p className="scoredetails-value">{testData.Score}<span className="scoredetails-unit"></span></p>
                            <h3>Score</h3>
                            {/* <div className="scoredetails-progress-bar">
                                <div className="scoredetails-progress" style={{ width: `${testData.Score}%` }}></div>
                            </div> */}
                        </div>
                    </div>
                    ...
                    <div className="scoredetails-summary-card scoredetails-secondary">
                        ...
                        <div className="scoredetails-content">
                            <p className="scoredetails-value">{testData.Rank}<span className="scoredetails-unit"></span></p>
                            <h3>Rank</h3>
                            {/* <div className="scoredetails-progress-bar">
                                <div className="scoredetails-progress" style={{ width: `${100 - testData.Rank}%` }}></div>
                            </div> */}
                        </div>
                    </div>
                </div>
